# 🏖️ Hacker House Goa 2026 — PFP Generator

An interactive, high-performance web app that lets builders create and customize their official **HH Goa 2026 Profile Badge (PFP)** and share it on X (Twitter).
...
- 🌴 **Authentic Goan Visual Aesthetic**: High-resolution tropical stamp frame with vibrant Goan motifs (`गोवा`, `2026`, Goa India stamp, lighthouse, sunset beach, hibiscus).
